...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ActionBasedControllerManager : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("The reference to the action of Snapshot with this controller.")]
        InputActionReference m_Snapshot;
        ...
        protected void Awake()
        {
            ...
            if (m_Snapshot != null)
                m_Snapshot.action.performed += TakeSnapshot;
        }
        ...
        void TakeSnapshot(InputAction.CallbackContext obj)
        {
            Debug.Log("Snapshot");
            VRScreenshotTaker.ActivateSaveCapturing();
        }
